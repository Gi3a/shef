	...
	<div class="block block-center block-row block-100 margin-1">
		<div class="block block-20 block-center">
			...
			<select name="category" onchange="top.location=this.value">
				<option value="/adverts">Все</option>
				<option value="/adverts/soup">Супы</option>
				<option value="/adverts/breakfast">Завтраки</option>
				<option value="/adverts/snack">Закуски</option>
			</select>
		</div>
		<div class="block block-20 block-center">
