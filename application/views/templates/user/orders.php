            ...
            <?php else: ?>
                ...
                <?php foreach ($list as $val): ?>
                    <div class="offer relative">
						...
						<a href="/edit/<?php echo $val['id'] ?>" class="border-black padding-1">Редактировать</a>
						<a href="/delete/<?php echo $val['id'] ?>" class="border-black padding-1">Удалить</a>
					</div>
                <?php endforeach; ?>
                 <div class="clearfix">
                    <?php echo $pagination; ?>
