	...
	<div class="block block-100 block-row">
		...
		<div class="block block-80 border-black block-column margin-3 padding-3" style="float: right">
			<div class="block block-100 block-column block-center">
				...
				<div class="block block-100 padding-1">
					<span class="block block-50">С <?php echo date('D-H:i',strtotime($data['working_on'])); ?></span>
					<span class="block block-50">До <?php echo date('D-H:i',strtotime($data['working_off'])); ?></span>
				</div>
			</div>
			<hr>
